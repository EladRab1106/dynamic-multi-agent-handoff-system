"""
FastAPI service for Direct Answer Agent using LangServe.

This service exposes the Direct Answer agent as a REST API with:
...
async def chat_with_agent(request: AgentChatRequest):
    ...
    This endpoint uses the agent's reasoning capabilities to provide
    direct and concise answers to user questions.
    """
    try:
