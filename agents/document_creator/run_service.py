"""
Run Document Creator agent as LangGraph Server.
...
if __name__ == "__main__":
    print("=" * 60)
    print("Document Creator Agent - LangGraph Server")
    print("=" * 60)
    print("\nTo run this agent, use LangGraph CLI:")
    print("  langgraph dev --port 8002")
    print("\nOr for production:")
    print("  langgraph serve --port 8002")
    print("\nThe agent will be accessible at:")
    print("  http://localhost:8002")
    print("\nGraph ID: document_creator")
    print("=" * 60)
